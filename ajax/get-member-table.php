...
function getMemberTable($count,$result){
    if ($count > 0) {
        ...
        foreach ($result as $row) {
            ...
            echo '<tr class="rw">';
            $image_link = $row[6];
            echo '<td style="vertical-align: middle;"><img style="border-radius:50%; width:50px; height: 50px; object-fit: cover " src="' . $image_link . '"
                onerror="this.onerror=null;this.src=\'Images/userPlaceholder.png\';" ></td>';
        ...
        echo "<span  style='color:red; margin-left: auto; margin-right: auto; display: table; margin-top: 50px;' class='features CardBgCol' > No available user</span>";
    }
}
?>
